...
const NAV: Item[] = [
  ...
  { type: "link", href: "/user/inbox", label: "Pending Signatures", Icon: Inbox },
  { type: "link", href: "/user/history", label: "History", Icon: History },
  { type: "link", href: "/user/activity", label: "My Activity", Icon: FileClock },
  ...
  { type: "link", href: "/user/request-head-role", label: "Request Head Role", Icon: Shield },
...
export default function UserLeftNav() {
  ...
  React.useEffect(() => {
    ...
    const fetchCount = async () => {
      try {
        // Use lightweight count endpoint instead of fetching full submissions
