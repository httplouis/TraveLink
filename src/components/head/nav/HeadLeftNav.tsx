...
const NAV: Item[] = [
  ...
  { type: "link", href: "/head/inbox", label: "For Endorsement", Icon: Inbox },
  { type: "link", href: "/head/history", label: "History", Icon: History },
  { type: "link", href: "/head/activity", label: "My Activity", Icon: FileClock },
