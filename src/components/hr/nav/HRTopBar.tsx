    ...
    <header className="fixed inset-x-0 top-0 z-50 h-14 bg-[#7a0019] text-white">
      <div className="flex h-full items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-3">
          <Link href="/hr/dashboard" className="inline-flex items-center gap-2">
          ...
          <span className="opacity-90">HR</span>
        </div>

        <div className="flex items-center gap-1">
          <Link href="/hr/notifications" className="relative rounded-full p-2 hover:bg-white/10" aria-label="Notifications">
            <Bell className="h-5 w-5" />
          </Link>
          <Link href="/hr/profile" className="rounded-full p-2 hover:bg-white/10" aria-label="Profile">
