// src/app/(protected)/president/request/page.tsx
"use client";
...
const RequestWizard = dynamic(
  async () => {
    try {
      ...
      console.error("[PresidentRequestPage] Failed to load RequestWizard:", error);
...
export default function PresidentRequestPage() {
  return (
    <ToastProvider>
      <div className="mx-auto max-w-6xl p-4">
        <RequestWizard />
