      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {items.length} {items.length === 1 ? 'request' : 'requests'} reviewed by President
          </p>
        </div>
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <span className="text-xs font-medium text-slate-500">
                    {formatDateTime(item.president_approved_at || item.rejected_at)}
                  </span>
                ...
                {item.president_comments && (
                  <div className="mt-2 p-2 bg-slate-50 rounded border border-slate-200">
                    <p className="text-xs text-slate-500">Your comments:</p>
                    <p className="text-sm text-slate-700">{item.president_comments}</p>
                  </div>
                )}
              </div>
