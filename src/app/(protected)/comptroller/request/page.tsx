// src/app/(protected)/comptroller/request/page.tsx
"use client";
...
const RequestWizard = dynamic(
  async () => {
    try {
      ...
      console.error("[ComptrollerRequestPage] Failed to load RequestWizard:", error);
...
export default function ComptrollerRequestPage() {
  return (
    <ToastProvider>
      <div className="mx-auto max-w-6xl p-4">
        <RequestWizard />
