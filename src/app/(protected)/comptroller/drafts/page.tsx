// src/app/(protected)/comptroller/drafts/page.tsx
"use client";
...
export default function ComptrollerDraftsPage() {
  ...
  async function handleLoad(id: string) {
    ...
    router.push(`/comptroller/request?draft=${encodeURIComponent(id)}`);
  }
